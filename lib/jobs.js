...
module.exports =  function(){
    ...
    NewJob("instagram_comments_fetch_0","0 * * * * *",()=>{
        const fetch_comments = require('../fetch/instagram_comments_fetch');
        fetch_comments("6475818983", "cc(182066202)", "https://www.instagram.com/p/CY-DPR-M678/").then(r => {
            console.log("ok")
        })
    })

    NewJob("instagram_comments_fetch_1","2 * * * * *",()=>{
        const fetch_comments = require('../fetch/instagram_comments_fetch');
        fetch_comments("6475818983", "cc(182066202)", "https://www.instagram.com/p/CY-DPR-M678/").then(r => {
            console.log("ok")
        })
